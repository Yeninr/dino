...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Food, function (sprite, otherSprite) {
    ...
    polloFrito.setPosition(randint(0, 140), randint(0, 100))
...
let carros: Sprite = null
let polloFrito: Sprite = null
...
scene.setBackgroundImage(img`
    ...
    bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
    `)
music.play(music.stringPlayable("C5 G A B A D G E ", 230), music.PlaybackMode.LoopingInBackground)
...
polloFrito = sprites.create(img`
    ...
    `, SpriteKind.Food)
forever(function () {
    carros = sprites.createProjectileFromSide(img`
        . . . . . . . 8 8 8 8 8 . . . . 
        . . . . . 8 8 6 6 6 6 6 8 . . . 
        . . . . 8 8 6 6 6 6 6 6 6 8 . . 
